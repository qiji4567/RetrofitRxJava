...
package com.qiji.network.net.token;

import android.text.TextUtils;

import com.qiji.network.net.common.CommonService;
import com.qiji.network.net.common.ResponseObserver;
import com.qiji.network.net.common.RetrofitService;
...
import com.qiji.network.net.module.BaseRequest;
...
public class ProxyHandler implements InvocationHandler {
    ...
    private void updateMethodToken(Method method, Object[] args) {
        String token = (String) SPUtils.get(Utils.getContext(), "token", "");
